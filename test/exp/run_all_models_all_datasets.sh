...
MODELS=(
    "8000:lmstudio-Qwen2.5-7B-Instruct,AgentFlow-7B-LMStudio,Base_Generator_Tool|Python_Coder_Tool|Google_Search_Tool|Wikipedia_Search_Tool,lmstudio-Qwen2.5-7B-Instruct|lmstudio-Qwen2.5-7B-Instruct|Default|Default"
)
