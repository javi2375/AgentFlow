"""
Integration tests for various agent frameworks with AgentFlow.

This module tests the integration of AgentFlow with:
- Autogen AgentChat
- LangChain/LangGraph
- OpenAI Agent SDK
- AgentOps
...
async def agent_autogen_mcp():
    ...
    async with McpWorkbench(calculator_mcp_server) as workbench:
        ...
        agent = AssistantAgent(name="rollout", model_client=model_client, workbench=workbench)
...
AGENTOPS_EXPECTED_TREES = {
    ...
    "agent_autogen_mcp": [
        ("rollout", "openai.chat.completion"),
    ],
...
def _debug_with_agentops():
    ...
    from agentflow.instrumentation.agentops_langchain import instrument_agentops_langchain
